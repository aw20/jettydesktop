...
import org.aw20.jettydesktop.controller.Executor;
import org.aw20.jettydesktop.controller.Start;
...
public class AppFunctions {
	...
	public String onServerStart(String serverName) throws IOException {
		return startServer(serverName);
	}
	
	public String onServerStop(String serverName) throws IOException {	
	...
	public void onMemory(String line) {
		...
		//Platform
		//webEngineSingleton.executeScript("document.getElementById('memory').innerHTML = '" + line + "'");
	}
	//TODO
	public void onLastUpdated(String line) {
		//call update last updated on jetty desktop app
		webEngineSingleton.executeScript("document.getElementById('updated').innerHTML = 'Last Updated: " + line + "'");
	}
	
	//private methods
	private String startServer(String serverId) {		
